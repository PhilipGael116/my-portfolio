        ...
        <div className="min-h-screen bg-[#0F172A] text-white">
            ...
            <GridBackground>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 py-20 px-5 sm:px-10 md:px-20 lg:px-32 w-full mt-10">
                    ...
                    <div className="relative group cursor-pointer bg-cover bg-center bg-no-repeat bg-[url('/hero-image.webp')] h-[450px] rounded-2xl overflow-hidden shadow-2xl border-t border-x border-white/10">
                    ...
                    <div className="flex flex-col gap-6">
                        <div className="relative flex-1 group cursor-pointer bg-cover bg-center bg-no-repeat bg-[url('/hero-image.webp')] min-h-[210px] rounded-2xl overflow-hidden shadow-xl border-x border-t border-white/10">
                            <div className="absolute inset-0 bg-linear-to-t via-black/40 to-transparent flex flex-col justify-end p-6 transition-all duration-300 from-black">
                                <p className="text-white font-semibold line-clamp-2">Mastering Framer Motion for Smooth Animations</p>
                            </div>
                        </div>
                        <div className="relative flex-1 group cursor-pointer bg-cover bg-center bg-no-repeat bg-[url('/hero-image.webp')] min-h-[210px] rounded-2xl overflow-hidden shadow-xl border border-white/10">
                            <div className="absolute inset-0 bg-linear-to-t via-black/40 to-transparent flex flex-col justify-end p-6 transition-all duration-300 from-black">
                            ...
                            {[1, 2, 3].map((i) => (
                                <div key={i} className="flex gap-4 group cursor-pointer">
                                    <div className="w-20 h-20 rounded-xl overflow-hidden shrink-0 border-t border-x border-white/10">
                                        <img src="/hero-image.webp" className="w-full h-full object-cover group-hover:scale-110 transition-transform" alt="trending" />
                                    </div>
