...
export function SpinningGlobe() {
    return (
        <div className="relative h-full w-full overflow-hidden rounded-xl sm:p-8 p-3 shadow-sm ring-1 shadow-black/10 ring-black/10 bg-gray-800 border border-white/5 sm:min-w-[340px] min-h-[300px]">
